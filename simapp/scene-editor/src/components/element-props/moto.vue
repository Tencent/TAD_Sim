<template>
  <el-form
    v-if="form"
    ref="form"
    class="property-form property-moto"
    size="small"
    :model="form"
    :rules="rules"
    label-width="98px"
      ...
      <el-collapse-item id="scenario-property-motion" :title="$t('scenario.motionControl')" name="motion">
        ...
        <el-form-item class="param-cell multi-input">
          ...
          <el-button
            ...
            class="solid-button"
            @click="motoTriggerConditionConfig"
          >
        ...
        <el-form-item class="param-cell multi-input">
          <div class="set-track-points-btns">
            <el-button
              size="small"
              class="solid-button"
              @click="setEnd({ type: 'moto', id: form.id })"
          ...
          >
            ...
            >
              <template #default="scope">
                <div :id="`moto-track-node-${scope.$index}`" @click="handleFocusTrackItem(scope.$index)">
                  <div class="position">
...
export default {
  ...
  methods: {
    ...
    pathNodeSelected (payload) {
      ...
      const el = document.getElementById(`moto-track-node-${index}`)
      if (type === 'moto') {
