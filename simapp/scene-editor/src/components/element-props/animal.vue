<template>
  <el-form
    v-if="form"
    ref="form"
    class="property-form property-animal"
    size="small"
    :model="form"
    :rules="rules"
    label-width="98px"
      ...
      <el-collapse-item id="scenario-property-motion" :title="$t('scenario.motionControl')" name="motion">
        ...
        <el-form-item class="param-cell multi-input">
          ...
          <el-button
            ...
            class="solid-button"
            @click="animalTriggerConditionConfig"
          >
        ...
        <el-form-item
          v-if="trajectoryEnabled"
          prop="start_angle"
          :label="$t('scenario.startAngle')"
          class="param-cell"
        >
          <InputNumber
        ...
        <el-form-item class="param-cell multi-input">
          <div class="set-track-points-btns">
            <el-button
              size="small"
              class="solid-button"
              @click="setEnd({ type: 'animal', id: form.id })"
            ...
            <el-icon
              :title="$t('operation.deleteAll')"
              @click="handleDeleteTrackItem(-1)"
            >
              <Delete />
            </el-icon>
          </div>
          ...
          >
            ...
            >
              <template #default="scope">
                <div :id="`animal-track-node-${scope.$index}`" @click="handleFocusTrackItem(scope.$index)">
                  <div class="position">
            ...
            >
              <template #default="scope">
                <div class="button-group">
                  ...
                  >
                    <el-icon :title="$t('operation.delete')">
                      <Delete />
                    </el-icon>
                  </el-button>
                </div>
...
export default {
  ...
  methods: {
    ...
    pathNodeSelected (payload) {
      ...
      const el = document.getElementById(`animal-track-node-${index}`)
      if (type === 'animal') {
