...
#ifndef RTW_HEADER_TxCar_private_h_
#define RTW_HEADER_TxCar_private_h_
...
SFB_EXTERN_C void driveline_sfunction_Start_wrapper(const int8_T *lic_path, const int_T p_width0,
                                                    const int8_T *par_path, const int_T p_width1);
SFB_EXTERN_C void driveline_sfunction_Outputs_wrapper(const driveline_in *DrivelineIn, const powecu_out *softecu_output,
                                                      driveline_out *DrivelineOut, const int8_T *lic_path,
                                                      const int_T p_width0, const int8_T *par_path,
                                                      const int_T p_width1);
SFB_EXTERN_C void driveline_sfunction_Terminate_wrapper(const int8_T *lic_path, const int_T p_width0,
                                                        const int8_T *par_path, const int_T p_width1);
...
extern void TxCar_derivatives();

#endif /* RTW_HEADER_TxCar_private_h_ */
