...
#ifndef RTW_HEADER_TX_DriveLine_private_h_
#define RTW_HEADER_TX_DriveLine_private_h_
...
extern void TX_DriveLine_derivatives();

#endif /* RTW_HEADER_TX_DriveLine_private_h_ */
