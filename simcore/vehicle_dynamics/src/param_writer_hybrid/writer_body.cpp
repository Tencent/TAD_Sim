...
void VehBodyWriter::fillSprungMass(tx_car::car &m_car) {
  ...
  /*
  tx_car::setRealScalar(sprung_mass->mutable_staticnormalfrontload()->mutable_fl(),
  "StaticNormalFrontLoad_FL", "static normal front left load", "kg", 446.31);
  tx_car::setRealScalar(sprung_mass->mutable_staticnormalfrontload()->mutable_fr(),
  "StaticNormalFrontLoad_FR", "static normal front right load", "kg", 446.31);
  tx_car::setRealScalar(sprung_mass->mutable_staticnormalrearload()->mutable_rr(),
  "StaticNormalRearLoad_RR", "static normal rear right load", "kg", 378.69);
  tx_car::setRealScalar(sprung_mass->mutable_staticnormalrearload()->mutable_rl(),
  "StaticNormalRearLoad_RL", "static normal rear left load", "kg", 378.69);
  */
