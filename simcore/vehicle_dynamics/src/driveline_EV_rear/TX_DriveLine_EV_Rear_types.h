...
#ifndef RTW_HEADER_TX_DriveLine_EV_Rear_types_h_
#define RTW_HEADER_TX_DriveLine_EV_Rear_types_h_
#include "rtwtypes.h"
...
typedef struct P_TX_DriveLine_EV_Rear_T_ P_TX_DriveLine_EV_Rear_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_TX_DriveLine_EV_Rear_T RT_MODEL_TX_DriveLine_EV_Rear_T;

#endif /* RTW_HEADER_TX_DriveLine_EV_Rear_types_h_ */
