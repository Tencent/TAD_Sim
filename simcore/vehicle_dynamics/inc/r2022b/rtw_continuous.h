...
typedef enum { SS_MATRIX_NONE, SS_MATRIX_CONSTANT, SS_MATRIX_TIMEDEP, SS_MATRIX_STATEDEP } ssMatrixType;
...
#ifdef RT_MALLOC
typedef real_T (*rtMdlDiscreteEventsFcn)(void* pModel, int_T rtmNumSampTimes, void* rtmTimingData,
                                         int_T* rtmSampleHitPtr, int_T* rtmPerTaskSampleHits);
#endif
...
#ifdef RT_MALLOC
#  define rtmiDiscreteEvents(M, x1, x2, x3, x4) ((*(M).rtmDiscreteEventsFcn)((M).rtModelPtr, (x1), (x2), (x3), (x4)))
#endif
