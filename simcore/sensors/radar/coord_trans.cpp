...
/**
 * @brief MatrixOperation
 *
 */
struct MatrixOperation {
  /**
   * @brief Multiply two matrices with size [3][3].
   *
   * @param A matrix A
   * @param B matrix B
   * @param Result
  ...
  /**
   * @brief matrices [3][3] multiply matrices with size [3][1].
   *
   * @param A matrix A
   * @param B matrix B
   * @param Result
