...
namespace eval {
class EvalPredictionMsg : public EvalBase {
 private:
  /**
   * @brief 用上升沿检测模版类
   */
 ...
 public:
   ...
   */
  static EvalBasePtr Build() { return std::make_shared<EvalPredictionMsg>(); }
};
}  // namespace eval
