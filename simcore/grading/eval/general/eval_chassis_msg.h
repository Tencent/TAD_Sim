...
namespace eval {
class EvalChassisMsg : public EvalBase {
 private:
  /**
   * @brief 用上升沿检测模版类
   */
 ...
 public:
  ...
  // update grading information of each step, such as kpi event used in simcity
  /**
   * @brief 指标评测结果写入方法
 ...
 public:
   ...
   */
  static EvalBasePtr Build() { return std::make_shared<EvalChassisMsg>(); }
};
}  // namespace eval
