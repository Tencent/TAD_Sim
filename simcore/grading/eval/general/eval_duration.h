 ...
 */
extern sim_msg::TestReport_PairData s_timeout_pair;

class EvalDuration : public EvalBase {
 private:
  /**
   * @brief 用上升沿检测模版类
   */
 ...
 public:
   ...
   */
  static EvalBasePtr Build() { return std::make_shared<EvalDuration>(); }
};
}  // namespace eval
