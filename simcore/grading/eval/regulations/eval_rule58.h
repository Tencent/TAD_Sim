...
namespace eval {
class EvalRule58 : public EvalBase {
 private:
  bool _cond_night;
  bool _cond_fog;
  bool _cond_rain;
  bool _cond_snow;
  bool _cond_low_visibility;
  bool _actual_beam_proper_used;
  bool _actual_harzard_proper_used;
  double _result;
 ...
 public:
   ...
   */
  static sim_msg::TestReport_XYPlot s_rule58_plot;
  /**
   ...
   */
  static EvalBasePtr Build() { return std::make_shared<EvalRule58>(); }
};
}  // namespace eval
