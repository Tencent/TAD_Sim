...
class EvalRule63 : public EvalBase {
 ...
 public:
   ...
   */
  static sim_msg::TestReport_XYPlot s_rule63_plot;
  /**
   ...
   */
  static EvalBasePtr Build() { return std::make_shared<EvalRule63>(); }
};
}  // namespace eval
