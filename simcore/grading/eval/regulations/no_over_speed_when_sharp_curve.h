...
//
// 条件1: 主车行驶在急弯上
// 判别: 条件1时,主车车速是否超过30kph
//
// 急弯定义
// https://www.zhihu.com/question/22071679
...
namespace eval {
class NoOverSpeedWhenSharpCurve : public EvalBase {
 private:
 ...
 public:
   ...
   * @brief 指标构造函数
   */
  NoOverSpeedWhenSharpCurve();
  /**
   * @brief 指标析构函数
   */
  virtual ~NoOverSpeedWhenSharpCurve() {}
 ...
 public:
   ...
   */
  static sim_msg::TestReport_XYPlot s_NoOverSpeedWhenSharpCurve_plot;
  /**
   ...
   */
  static EvalBasePtr Build() { return std::make_shared<NoOverSpeedWhenSharpCurve>(); }
};
}  // namespace eval
