...
namespace eval {
class NoUTurnWhenCrosswalks : public EvalBase {
 private:
 ...
 public:
   ...
   * @brief 指标构造函数
   */
  NoUTurnWhenCrosswalks();
  /**
   * @brief 指标析构函数
   */
  virtual ~NoUTurnWhenCrosswalks() {}
 ...
 public:
   ...
   */
  static sim_msg::TestReport_XYPlot s_no_u_turn_when_crosswalks_plot;
  /**
   ...
   */
  static EvalBasePtr Build() { return std::make_shared<NoUTurnWhenCrosswalks>(); }
};
}  // namespace eval
