...
namespace eval {
class NoOverSpeedWhenNoCenterLaneOnCityRoad : public EvalBase {
 private:
 ...
 public:
   ...
   * @brief 指标构造函数
   */
  NoOverSpeedWhenNoCenterLaneOnCityRoad();
  /**
   * @brief 指标析构函数
   */
  virtual ~NoOverSpeedWhenNoCenterLaneOnCityRoad() {}
 ...
 public:
   ...
   */
  static sim_msg::TestReport_XYPlot s_NoOverSpeedWhenNoCenterLaneOnCityRoad_plot;
  /**
   ...
   */
  static EvalBasePtr Build() { return std::make_shared<NoOverSpeedWhenNoCenterLaneOnCityRoad>(); }
};
}  // namespace eval
