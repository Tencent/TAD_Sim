...
class EvalRule57 : public EvalBase {
 ...
 public:
   ...
   */
  static sim_msg::TestReport_XYPlot s_rule57_plot;
  /**
   ...
   */
  static EvalBasePtr Build() { return std::make_shared<EvalRule57>(); }
};
}  // namespace eval
