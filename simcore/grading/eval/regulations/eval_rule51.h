...
namespace eval {
class EvalRule51 : public EvalBase {
 private:
  bool _cond_night;
  ...
  bool _result_beam_proper_used;
  bool _result_indicator_proper_used;
  bool _result_run_red_light;
  bool _result_follow_dir;
  hadmap::LANE_ARROW _cond_lane_arrow;
  double _result;
 ...
 public:
   ...
   */
  static sim_msg::TestReport_XYPlot s_rule51_plot;
  /**
   ...
   */
  static EvalBasePtr Build() { return std::make_shared<EvalRule51>(); }
};
}  // namespace eval
