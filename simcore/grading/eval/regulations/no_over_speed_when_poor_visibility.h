...
namespace eval {
class NoOverSpeedWhenPoorVisibility : public EvalBase {
 private:
  bool _cond_rain;
  bool _cond_snow;
  bool _cond_fog;
 ...
 public:
   ...
   * @brief 指标构造函数
   */
  NoOverSpeedWhenPoorVisibility();
  /**
   * @brief 指标析构函数
   */
  virtual ~NoOverSpeedWhenPoorVisibility() {}
 ...
 public:
   ...
   */
  static sim_msg::TestReport_XYPlot s_NoOverSpeedWhenPoorVisibility_plot;
  /**
   ...
   */
  static EvalBasePtr Build() { return std::make_shared<NoOverSpeedWhenPoorVisibility>(); }
};
}  // namespace eval
