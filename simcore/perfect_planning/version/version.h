...
#define FILE_VERSION_STR(branch, commit_id) \
  "V" Stringizing(branch) "." Stringizing(commit_id) "-" "20260709" "-" "034656"

// generate product version
#define PRODUCT_VERSION_STR(major, minor, build, revision) \
  "V" Stringizing(major) "." Stringizing(minor) "." Stringizing(build) "." Stringizing(revision) "-" "20260709" "T" "034656"
