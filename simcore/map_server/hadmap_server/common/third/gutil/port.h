...
#include "common/gutil/integral_types.h"
...
static inline uint16 bswap_16(uint16 x) { return ((x & 0xFF) << 8) | ((x & 0xFF00) >> 8); }
...
static inline uint64 bswap_64(uint64 x) {
  return (((x & GG_ULONGLONG(0xFF)) << 56) | ((x & GG_ULONGLONG(0xFF00)) << 40) | ((x & GG_ULONGLONG(0xFF0000)) << 24) |
          ((x & GG_ULONGLONG(0xFF000000)) << 8) | ((x & GG_ULONGLONG(0xFF00000000)) >> 8) |
          ((x & GG_ULONGLONG(0xFF0000000000)) >> 24) | ((x & GG_ULONGLONG(0xFF000000000000)) >> 40) |
...
inline void* aligned_malloc(size_t size, int minimum_alignment) { return _aligned_malloc(size, minimum_alignment); }

inline void aligned_free(void* aligned_memory) { _aligned_free(aligned_memory); }
...
#elif defined(__arm__) && !defined(__ARM_ARCH_5__) && !defined(__ARM_ARCH_5T__) && !defined(__ARM_ARCH_5TE__) && \
    !defined(__ARM_ARCH_5TEJ__) && !defined(__ARM_ARCH_6__) && !defined(__ARM_ARCH_6J__) &&                      \
    !defined(__ARM_ARCH_6K__) && !defined(__ARM_ARCH_6Z__) && !defined(__ARM_ARCH_6ZK__) && !defined(__ARM_ARCH_6T2__)
...
template <class T>
using enable_if_numeric = std::enable_if<std::is_arithmetic<T>::value || std::is_same<T, __int128>::value, T>;
...
//
template <typename T, typename port_internal::enable_if_numeric<T>::type* = nullptr>
