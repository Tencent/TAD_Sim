...
#include "common/gutil/strings/numbers.h"
#include "common/gutil/strings/stringpiece.h"
...
class SubstituteArg {
 public:
  ...
  inline SubstituteArg(long value)  // NOLINT(runtime/explicit)
      : text_(scratch_),
        size_((sizeof(value) == 4 ? FastInt32ToBufferLeft(value, scratch_) : FastInt64ToBufferLeft(value, scratch_)) -
              scratch_) {}
  inline SubstituteArg(unsigned long value)  // NOLINT(runtime/explicit)
      : text_(scratch_),
        size_((sizeof(value) == 4 ? FastUInt32ToBufferLeft(value, scratch_) : FastUInt64ToBufferLeft(value, scratch_)) -
              scratch_) {}
...
void SubstituteAndAppend(std::string* output, StringPiece format,
...
inline std::string Substitute(StringPiece format, const internal::SubstituteArg& arg0 = internal::SubstituteArg::kNoArg,
                              const internal::SubstituteArg& arg1 = internal::SubstituteArg::kNoArg,
                              const internal::SubstituteArg& arg2 = internal::SubstituteArg::kNoArg,
                              const internal::SubstituteArg& arg3 = internal::SubstituteArg::kNoArg,
                              const internal::SubstituteArg& arg4 = internal::SubstituteArg::kNoArg,
