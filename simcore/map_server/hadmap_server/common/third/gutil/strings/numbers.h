...
#include "common/gutil/int128.h"
#include "common/gutil/integral_types.h"
#include "common/gutil/macros.h"
#include "common/gutil/port.h"
#include "common/gutil/stringprintf.h"
...
struct autodigit_less : public std::binary_function<const std::string&, const std::string&, bool> {
  bool operator()(const std::string& a, const std::string& b) const {
    return AutoDigitLessThan(a.data(), a.size(), b.data(), b.size());
  }
};

struct autodigit_greater : public std::binary_function<const std::string&, const std::string&, bool> {
  bool operator()(const std::string& a, const std::string& b) const {
    return AutoDigitLessThan(b.data(), b.size(), a.data(), a.size());
  }
};

struct strict_autodigit_less : public std::binary_function<const std::string&, const std::string&, bool> {
  bool operator()(const std::string& a, const std::string& b) const {
    return StrictAutoDigitLessThan(a.data(), a.size(), b.data(), b.size());
  }
};

struct strict_autodigit_greater : public std::binary_function<const std::string&, const std::string&, bool> {
  bool operator()(const std::string& a, const std::string& b) const {
...
inline std::string FloatToString(float f) { return StringPrintf("%7f", f); }

// DEPRECATED(wadetregaskis).  Just call StringPrintf.
inline std::string IntToString(int i) { return StringPrintf("%7d", i); }

// DEPRECATED(wadetregaskis).  Just call StringPrintf.
inline std::string Int64ToString(int64 i64) { return StringPrintf("%7" PRId64, i64); }

// DEPRECATED(wadetregaskis).  Just call StringPrintf.
inline std::string UInt64ToString(uint64 ui64) { return StringPrintf("%7" PRIu64, ui64); }
