...
CJsonObject::CJsonObject(const std::string& strJson) : m_pJsonData(NULL), m_pExternJsonDataRef(NULL) { Parse(strJson); }
...
std::string CJsonObject::operator()(const std::string& strKey) const {
  ...
  if (pJsonStruct->type == cJSON_String) {
    ...
    if (pJsonStruct->sign == -1) {
      if (static_cast<int64>(pJsonStruct->valueint) <= INT_MAX &&
          static_cast<int64>(pJsonStruct->valueint) >= INT_MIN) {
        snprintf(szNumber, sizeof(szNumber), "%d", static_cast<int32>(pJsonStruct->valueint));
      } else {
        snprintf(szNumber, sizeof(szNumber), "%lld", static_cast<int64>(pJsonStruct->valueint));
      }
    } else {
      if (pJsonStruct->valueint <= UINT_MAX) {
        snprintf(szNumber, sizeof(szNumber), "%u", static_cast<uint32>(pJsonStruct->valueint));
      } else {
...
bool CJsonObject::Get(const std::string& strKey, int32& iValue) const {
  ...
  iValue = static_cast<int32>(pJsonStruct->valueint);
  return (true);
}
...
bool CJsonObject::Get(const std::string& strKey, uint32& uiValue) const {
  ...
  uiValue = static_cast<uint32>(pJsonStruct->valueint);
  return (true);
}
...
bool CJsonObject::Get(const std::string& strKey, int64& llValue) const {
  ...
  llValue = static_cast<int64>(pJsonStruct->valueint);
  return (true);
}
...
bool CJsonObject::Get(const std::string& strKey, uint64& ullValue) const {
  ...
  ullValue = static_cast<uint64>(pJsonStruct->valueint);
  return (true);
}
...
bool CJsonObject::Get(const std::string& strKey, float& fValue) const {
  ...
  fValue = static_cast<float>(pJsonStruct->valueint);
  return (true);
}
...
bool CJsonObject::Add(const std::string& strKey, int32 iValue) {
  ...
  cJSON* pJsonStruct = cJSON_CreateInt(static_cast<uint64>(iValue), -1);
  if (pJsonStruct == NULL) {
    return (false);
  }
  cJSON_AddItemToObject(pFocusData, strKey.c_str(), pJsonStruct);
...
bool CJsonObject::Add(const std::string& strKey, uint32 uiValue) {
  ...
  cJSON* pJsonStruct = cJSON_CreateInt(static_cast<uint64>(uiValue), 1);
  if (pJsonStruct == NULL) {
    return (false);
  }
  cJSON_AddItemToObject(pFocusData, strKey.c_str(), pJsonStruct);
...
bool CJsonObject::Add(const std::string& strKey, int64 llValue) {
  ...
  cJSON* pJsonStruct = cJSON_CreateInt(static_cast<uint64>(llValue), -1);
  if (pJsonStruct == NULL) {
    return (false);
  }
  cJSON_AddItemToObject(pFocusData, strKey.c_str(), pJsonStruct);
...
bool CJsonObject::Add(const std::string& strKey, float fValue) {
  ...
  cJSON* pJsonStruct = cJSON_CreateDouble(static_cast<double>(fValue), -1);
  if (pJsonStruct == NULL) {
    return (false);
  }
  cJSON_AddItemToObject(pFocusData, strKey.c_str(), pJsonStruct);
...
bool CJsonObject::Add(const std::string& strKey, double dValue) {
  ...
  cJSON* pJsonStruct = cJSON_CreateDouble(static_cast<double>(dValue), -1);
  if (pJsonStruct == NULL) {
    return (false);
  }
  cJSON_AddItemToObject(pFocusData, strKey.c_str(), pJsonStruct);
...
bool CJsonObject::Replace(const std::string& strKey, uint64 ullValue) {
  ...
  cJSON* pJsonStruct = cJSON_CreateInt(static_cast<uint64>(ullValue), 1);
  if (pJsonStruct == NULL) {
    return (false);
  }
  cJSON_ReplaceItemInObject(pFocusData, strKey.c_str(), pJsonStruct);
